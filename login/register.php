...
if(!$sql){
	...
	// Let's mail the user!
	$subject = "Your Membership at domain.com!";
	$message = "Dear $first_name $last_name,
	Thank you for registering at our website, http://www.domain.com!
	
	You are two steps away from logging in and accessing our exclusive members area.
	
	To activate your membership, please click here: http://www.domain.com/activate.php?id=$userid&code=$db_password
